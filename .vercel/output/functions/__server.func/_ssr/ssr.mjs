...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B-y_4PGx.mjs");
...
var manifest = { "6ba92ff8eed8b828c583f83f1eb8ebeac414e500e2d6d648b942ec8fda59a12a": {
	functionName: "generateBriefing_createServerFn_handler",
	importer: () => import("./generate-briefing-CHqtVbK8.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B8G_sDhA.mjs").then((n) => n.t),
